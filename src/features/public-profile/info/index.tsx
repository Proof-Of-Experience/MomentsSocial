						...
						<div>
							...
							<div className="text-right mt-3">
								<p>
									...
									<span className="font-bold"> ≈{desoPrice(exchangeData?.USDCentsPerDeSoExchangeRate)}</span>
								</p>
								<p>
									<span>Your $DESO</span>
									<span className="font-bold">
										{nanosToUSD(authUser?.Profile?.DESOBalanceNanos, 2)} ≈{desoPrice(exchangeData?.USDCentsPerDeSoExchangeRate)}
									</span>
								</p>
							</div>
						</div>
