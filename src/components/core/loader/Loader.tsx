...
const LoadingSpinner = ({ isLoading, fullHeight }: LoadingSpinnerProps) => {
    return (
        <div className={`spinner-container ${isLoading ? '' : 'hidden'} z-10 grid justify-center items-center ${fullHeight ? 'bg-gray-200/75 fixed w-[calc(100%_-_72px)] h-[calc(100vh_-_72px)]' : 'relative mt-10'}`}>
