...
const Notifications = ({ notifications }: NotificationProps) => {
	return (
		<div className="bg-white mt-[10px] py-4 w-full min-[420px]:w-[350px] origin-top-right rounded-md shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none transform opacity-100 scale-100">
